...
import com.example.myapplication.data.response.MovieResponse
import com.example.myapplication.data.response.NowPlayingResponse
import com.example.myapplication.data.response.TopRatedResponse
import com.example.myapplication.data.response.UpcomingResponse
